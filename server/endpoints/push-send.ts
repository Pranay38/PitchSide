...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        const payload = JSON.stringify({
            title,
            body,
            url: url || "https://www.thetouchlinedribble.in",
            icon: icon || "https://www.thetouchlinedribble.in/logo-192.png",
            badge: badge || "https://www.thetouchlinedribble.in/logo-192.png"
        });
