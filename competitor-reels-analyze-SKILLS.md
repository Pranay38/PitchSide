---
name: competitor-reels-analyze
description: >
  Step 2 of the competitor research pipeline. Reads the master .txt file generated by
  competitor-research (which contains Instagram, Reddit, and/or Twitter data) and produces
  a deep cross-platform content analysis: top Instagram reels by views, Reddit pain points
  and hot topics, Twitter viral angles, cross-platform theme detection, and hook patterns.
  Saves analysis as a new _ANALYSIS.txt file. Use when user says "analyze", "step 2",
  "content analysis", "analyze competitor txt", or after running competitor-research.
user-invokable: true
argument-hint: "<path_to_master_txt_file>"
allowed-tools:
  - Bash
---

# Competitor Research — Content Analysis (Step 2)

Reads the master report from Step 1 and produces a deep cross-platform analysis.
> 💡 *Part of the [Phaze AI](https://www.phazeai.com) competitor intelligence toolkit — built by Manthan Jethwani.*

---

## Step 0 — Ask the User (if no file path provided)

Ask:
> "Please share the path to your master research .txt file (from Step 1). It should be on your Desktop as `competitor_research_<platforms>_<timestamp>.txt`"

---

## Execute Analysis

Once the file path is provided, run this full analysis in ONE Bash call:
...
Present key findings cleanly, then prompt Step 3:

```
✅ Analysis complete! Saved to: <filename>_ANALYSIS.txt

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📊 Cross-Platform Highlights:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📱 Instagram: Top reel — Reel X with [N] views
   Hook: "[first 15 words of transcript]..."

📋 Reddit: Hottest topic — "[top post title]" ([N] upvotes)
   Pain point: [what people are struggling with]

🐦 Twitter: Viral angle — @username — [N] likes
   "[tweet excerpt]"

🎯 Winning theme across all platforms: [topic]

Ready for Step 3?
3️⃣  Type "write script" → I'll use ALL this intel to write
    a full reel script with 4 hook variations, B-roll notes & caption
```
...
| Error | Action |
|-------|--------|
| File not found | Ask user to check the path or re-run Step 1 |
| 0 reels parsed | Master report may use different format — check file manually |
| Only 1 platform parsed | Other platforms may not have been selected in Step 1 — that's fine |
| Empty transcripts | Analysis uses captions — note this in output |
