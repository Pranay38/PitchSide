...
export const ContainerTextScroll = ({
  ...
  const titleTranslateY = useTransform(scrollYProgress, [0, 1], [200, 0]);
  const titleScale = useTransform(scrollYProgress, [0, 1], [0.8, 1.2]);

  return (
    <div
      ref={containerRef}
      className="h-[50rem] md:h-[60rem] flex items-center justify-center relative p-2 md:p-20 overflow-hidden"
    >
      <motion.div
        style={{ translateY }}
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="relative h-[30rem] md:h-[40rem] w-full border-4 border-[#16A34A]/30 bg-[#222222] rounded-[30px] shadow-2xl overflow-hidden pointer-events-auto"
    >
      <div className="h-full w-full rounded-2xl bg-gray-100 dark:bg-zinc-900 overflow-hidden relative">
