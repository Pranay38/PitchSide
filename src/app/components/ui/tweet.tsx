...
export const TweetNotFound = ({ className }: { className?: string }) => (
  <div
    className={cn(
        ...
        <div className="mt-2.5 flex gap-4 border-t border-muted pt-3.5">
          {showLikeButton && (
            ...
            >
              ...
              <span className="text-sm font-medium transition-colors hover:text-pink-600">
...
export function Tweet({
  ...
  // Demo mock tweet for this component until backend integration happens
  const tweet = {
    id_str: id,
    text: "Football is about passion and moments! Every component is accessible, composable, and beautiful. ✨",
    created_at: "Mon Mar 04 18:30:00 +0000 2026",
    favorite_count: 2847,
    ...
    user: {
      id_str: "12345",
      name: "Tactics Editor",
      profile_image_url_https: "https://images.unsplash.com/photo-1543351611-58f69d7c1781?w=100&h=100&fit=crop",
      screen_name: "touchlinedribble",
      verified: false,
